...
CREATE TABLE `tbl_produtos` (
  ...
  `preco_atual` decimal(10,2) unsigned NOT NULL,
  ...
  KEY `idx_prod_ativo_cat` (`ativo`,`id_categoria`),
  KEY `idx_prod_nome` (`nome`),
  KEY `idx_prod_cat` (`id_categoria`),
  CONSTRAINT `fk_prod_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tbl_categorias` (`id_categoria`)
