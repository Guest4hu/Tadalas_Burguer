...
CREATE TABLE `tbl_pagamento` (
  ...
  KEY `idx_pg_ped` (`id_pedido`),
  KEY `idx_pg_status` (`status_id`,`created_at`),
  CONSTRAINT `fk_pg_ped` FOREIGN KEY (`id_pedido`) REFERENCES `tbl_pedidos` (`id_pedido`),
  CONSTRAINT `fk_pg_status` FOREIGN KEY (`status_id`) REFERENCES `dom_status_pagamento` (`id`)
