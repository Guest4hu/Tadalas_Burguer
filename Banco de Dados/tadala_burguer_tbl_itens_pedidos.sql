...
CREATE TABLE `tbl_itens_pedidos` (
  ...
  PRIMARY KEY (`id_item`),
  KEY `idx_item_ped` (`id_pedido`),
  KEY `idx_item_prod` (`id_produto`),
  CONSTRAINT `fk_item_ped` FOREIGN KEY (`id_pedido`) REFERENCES `tbl_pedidos` (`id_pedido`),
  CONSTRAINT `fk_item_prod` FOREIGN KEY (`id_produto`) REFERENCES `tbl_produtos` (`id_produto`)
...
-- Dump completed on 2025-08-28 10:47:52
