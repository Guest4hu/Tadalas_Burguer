...
CREATE TABLE `tbl_contas_receber` (
  ...
  `recebimento_previsto` date NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cr_cat` (`categoria_id`),
  KEY `fk_cr_ped` (`pedido_id`),
  KEY `idx_cr_prev` (`recebimento_previsto`,`status`),
  CONSTRAINT `fk_cr_cat` FOREIGN KEY (`categoria_id`) REFERENCES `tbl_plano_contas` (`id`),
  CONSTRAINT `fk_cr_ped` FOREIGN KEY (`pedido_id`) REFERENCES `tbl_pedidos` (`id_pedido`)
