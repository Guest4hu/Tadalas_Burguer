...
<div class="form-card">
    <h3><i class="fa fa-edit"></i> Editar Promoção</h3>
    ...
    <form method="POST" action="/backend/promocoes/atualizar" autocomplete="off">
        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'] ?? ''; ?>">
        <input type="hidden" name="id" value="<?php echo $promocao_id; ?>">
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-primary">
                <i class="fa fa-save"></i> Atualizar Promoção
            </button>
        </div>
    </form>
</div>