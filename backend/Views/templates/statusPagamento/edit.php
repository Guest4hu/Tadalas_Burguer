<?php
$status_pagamento_id = htmlspecialchars($status['status_pagamento_id'] ?? '', ENT_QUOTES, 'UTF-8');
...
<div class="form-card">
    <h3><i class="fa fa-credit-card"></i> Editar Status de Pagamento</h3>
    ...
    <form method="POST" action="/backend/statuspagamento/atualizar" autocomplete="off">
        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'] ?? ''; ?>">
        <input type="hidden" name="status_pagamento_id" value="<?php echo $status_pagamento_id; ?>">

        <div class="w3-section">
            <label for="descricao"><i class="fa fa-align-left"></i> Descrição do Status</label>
            <textarea id="descricao" name="descricao" placeholder="Ex: Pendente, Pago, Cancelado" required maxlength="255"><?php echo $descricao; ?></textarea>
        </div>

        <div class="form-actions">
            <a href="/backend/statuspagamento/index" class="btn-cancel">
