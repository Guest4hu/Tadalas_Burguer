<?php
$status_funcionario_id = htmlspecialchars($status['status_funcionario_id'] ?? '', ENT_QUOTES, 'UTF-8');
...
<div class="form-card">
    <h3><i class="fa fa-user-check"></i> Editar Status de Funcionário</h3>
    ...
    <form method="POST" action="/backend/statusfuncionario/atualizar" autocomplete="off">
        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'] ?? ''; ?>">
        <input type="hidden" name="status_funcionario_id" value="<?php echo $status_funcionario_id; ?>">

        <div class="w3-section">
            <label for="descricao"><i class="fa fa-align-left"></i> Descrição do Status</label>
            <textarea id="descricao" name="descricao" placeholder="Ex: Ativo, Inativo, Férias" required maxlength="255"><?php echo $descricao; ?></textarea>
        </div>

        <div class="form-actions">
            <a href="/backend/statusfuncionario/index" class="btn-cancel">
