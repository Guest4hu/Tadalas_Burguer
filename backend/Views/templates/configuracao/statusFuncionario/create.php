...
<div class="form-card">
    <h3><i class="fa fa-user-check"></i> Criar Novo Status de Funcionário</h3>
    ...
    <form method="POST" action="/backend/statusfuncionario/salvar" autocomplete="off">
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-primary">
                <i class="fa fa-save"></i> Salvar Status
            </button>
        </div>
    </form>
</div>