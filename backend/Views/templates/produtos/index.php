        ...
        <tbody>
           <?php foreach ($produtos as $produto): ?>
              <tr>
                 ...
                 <td><a href="/backend/produto/editar/<?= htmlspecialchars($produto['produto_id']) ?>">Editar</a></td>
                 <td><a href="/backend/produto/excluir/<?= htmlspecialchars($produto['produto_id']) ?>">Excluir</a></td>
              </tr>
           <?php endforeach; ?>
        </tbody>
    </table>
