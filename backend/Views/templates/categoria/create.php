...
// Captura valores do formulário (se vierem via POST) e prepara para exibição
$nome = isset($_POST['nome']) ? trim($_POST['nome']) : '';
$descricao = isset($_POST['descricao']) ? trim($_POST['descricao']) : '';

// Escapa para evitar problemas de HTML/JS ao reexibir nos campos
...
<div class="form-card">
    <h3><i class="fa fa-folder-plus"></i> Criar Nova Categoria</h3>
