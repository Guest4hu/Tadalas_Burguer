...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-mark { font-size: 1.625rem; line-height: 1; }
    ...
    .field-inner input::placeholder { color: var(--text-muted); }
    ...
    .field-row a:hover { color: var(--accent-red); }
    ...
    .btn-submit .btn-label { display: block; }
    ...
    .form-heading  { animation-delay: 0.12s; }
    .divider       { animation-delay: 0.18s; }
    form           { animation-delay: 0.22s; }
    .login-footer-links { animation-delay: 0.28s; }
  </style>
</head>
    ...
    <main class="login-form-panel" id="conteudo">
      <div class="form-inner">
        ...
        <div class="login-footer-links">
          Ainda não tem conta?
          <a href="/backend/register?redirect=<?php echo urlencode($redirect ?? '/carrinho.php'); ?>">Criar conta grátis</a>
        </div>
