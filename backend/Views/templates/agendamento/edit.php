<?php
$agendamento_id = htmlspecialchars($agendamento['agendamento_id'] ?? '', ENT_QUOTES, 'UTF-8');
$usuario_id = htmlspecialchars($agendamento['usuario_id'] ?? '', ENT_QUOTES, 'UTF-8');
$mesa_id = htmlspecialchars($agendamento['mesa_id'] ?? '', ENT_QUOTES, 'UTF-8');
$data_hora_inicio = htmlspecialchars($agendamento['data_hora_inicio'] ?? '', ENT_QUOTES, 'UTF-8');
$data_hora_fim = htmlspecialchars($agendamento['data_hora_fim'] ?? '', ENT_QUOTES, 'UTF-8');
?>
...
<div class="form-card">
    <h3><i class="fa fa-calendar-check"></i> Editar Agendamento</h3>
    ...
    <form method="POST" action="/backend/agendamento/atualizar" autocomplete="off">
        ...
        <div class="w3-section">
            ...
            <select id="mesa_id" name="mesa_id" required>
                ...
                <!-- Carregar dinamicamente do banco com selected="<?php echo $mesa_id; ?>" -->
            </select>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-primary">
                <i class="fa fa-save"></i> Atualizar Agendamento
            </button>
        </div>
    </form>
</div>