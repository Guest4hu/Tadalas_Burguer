...
use App\Tadala\Core\EmailService;
...
class NotificationService{
    ...
    public function enviarEmailDeBoasVindas(array $userData): bool {
        ...
        $assunto = "Bem-vindo(a) à Plataforma Tadala!";
        ...
        $mensagem .= "<p>Atenciosamente,<br>Equipe Tadala</p>";
    ...
    public function enviarEmailDeEqueciASenha(array $userData, string $token): bool {
        ...
        $assunto = "Redefinição de Senha - Tadala";
        $mensagem = "<p>Olá,</p>";
