...
{   
    ...
    public function viewListarPedidos($pagina = 1, $por_pagina = 5)
    {
        ...
        // $buscaMetodo = $this->metodo_pagamento->buscarTodosMetodosPagamento();
        $buscaStatus = $this->status_pagamento->buscarTodosStatusPagamento();
        ...
        View::render(
            "pedidos/index",
            [
                 'status_pagamento' => $buscaStatus,
                // 'metodos_pagamento' => $buscaMetodo,
